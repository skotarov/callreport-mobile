...
internal class MainSettingsAutoSaveController(
    ...
    fun wire() {
        ...
        listOf(
            ...
            remote.configPathInput,
            remote.standaloneLookupPathInput,
            remote.homeNotesPathInput,
            remote.propertySearchPathInput,
            remote.standaloneFormPathInput,
            remote.standaloneHistoryPathInput,
            remote.submitPathInput,
